# Deposit Liquidity and Mint A Position on Sushi Swap

The Sushi Swap Deposit adapter outlines a feature that enables users holding funds on any compatible chain to add liquidity and mint a new position on Sushi Swap in one step.  

## Components of the Sushi Swap Adapter contract
...
**3. "_mint" Function:** This function is responsible for calling the Non-fungible position manager, minting the position on Sushi Swap and transferring the LP asset to the user/recipient.
