# Deposit Liquidity and Mint A Position on Nuri V3

The Nuri Deposit adapter outlines a feature that enables users holding funds on any compatible chain to add liquidity and mint a new position on Nuri V3 in one step.  
...
**3. "_mint" Function:** This function is responsible for calling the Non-fungible position manager, minting the position on Nuri and transferring the LP asset to the user/recipient.
