# Deposit Liquidity and Mint A Position on Thena

The Thena Deposit adapter outlines a feature that enables users holding funds on any compatible chain to add liquidity and mint a new position on Thena in one step.  

## Components of the Thena Adapter contract
...
**3. "_mint" Function:** This function is responsible for calling the Non-fungible position manager, minting the position on Thena and transferring the LP asset to the user/recipient.